...
public class LazyInitializationHandler implements InvocationHandler {
    ...
    // designpattern.proxy: 클라이언트가 호출하는 프록시 객체이므로, invoke 메서드가 호출될 때 프록시 객체 자체가 이 인자로 전달된다.
...
//        } else {
//            throw new IllegalArgumentException("Created designpattern.proxy is not of the expected type: " + interfaceType.getName());
//        }
//    }
}