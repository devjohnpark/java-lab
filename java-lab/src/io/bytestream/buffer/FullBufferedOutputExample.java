...
public class FullBufferedOutputExample {
    ...
    public static void main(String[] args) {
        ...
        try (FileOutputStream fileOutputStream = new FileOutputStream(getFileName());
            ...
            readFileWithBufferedInputStream(getFileName()); // [Content] Hello, this is an example of full buffer
            ...
            readFileWithBufferedInputStream(getFileName()); // [Content] Hello, this is an example of full buffered output.
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
